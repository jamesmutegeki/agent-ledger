...
export const CommitsGrid = ({ text }: { text: string }) => {
  ...
  return (
    <section
      className="w-full max-w-xl bg-white border border-green-200 grid p-1.5 sm:p-3 gap-0.5 sm:gap-1 rounded-[10px] sm:rounded-[15px]"
      style={{
        ...
        return (
          <div
            ...
            className={cn(
              ...
              !isHighlighted && !shouldFlash ? "bg-white" : ""
            )}
            style={
              {
