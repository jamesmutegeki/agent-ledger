...
A clean, minimalist web application for agents to log and track daily financial transactions. Built with a light green and white theme for a fresh, professional look.
...
- **Live Summary Dashboard** — See aggregated totals for deposits, withdrawals, and commissions at a glance
