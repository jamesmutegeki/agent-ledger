...
The app loads with 10 sample transactions on first visit so you can see the activity feed, summary dashboard, and end-of-day report in action. Click **"Load demo data"** below the form to reset the demo, or **"Clear all"** to start fresh.
